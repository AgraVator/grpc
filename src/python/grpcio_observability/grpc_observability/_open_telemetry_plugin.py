    ...
    def __init__(
        ...
        *,
        ...
        or None which means no metrics will be collected.
          tracer_provider: A TracerProvider which will be used to collect tracing data,
        or None which means no tracing data will be collected.
          text_map_propagator: A TextMapPropagator which will be used for context
        propagation, or None to use default context propagation.
